...
import { AppBar, List, Switch, Typography } from "@mui/material";
import { Box, styled } from "@mui/system";

const barStyle = (theme: any) => ({
...
export const SearchContainer = styled(Box)(({ theme, normal }: any) => ({
...
export const MenuLinkContainer = styled(Typography)(
  ({ theme, active }: any) => ({
    cursor: "pointer",
    color: `${
      active ? theme.palette.action.hover : theme.palette.text.primary
